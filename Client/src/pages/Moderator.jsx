...
const handleDeleteUser = async (username) => {
        ...
        onClick: async () => {
          try {
            ...
            if (user?.role !== 'moderator') {
              alert('Only moderators can delete users');
              return;
            }
            ...
            await api.delete(`/users/${username}/delete/`, {
              data: {
                ...
                password: prompt('Please enter your moderator password to confirm:') // Ask for password confirmation
              }
            });
  ...
  return (
    ...
    >
      {/* Navbar */}
      <Navbar activePage="moderator" onProfileClick={toggleProfilePanel} />
                ...
                <div>
                    ...
                    <div className={`lg:col-span-2 rounded-2xl p-6 shadow-lg transition-all duration-300 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
                      ...
                      <div>
                        ...
                        <p className={`mb-4 transition-colors duration-200 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                          {user?.bio || 'Responsible for maintaining the integrity and quality of the TechSage platform content.'}
                        </p>
                      </div>
                    </div>
                    <div className="space-y-4">
                  ...
                  <div className={`rounded-2xl p-6 mb-6 h-80 transition-all duration-300 ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg`}>
                    <h3 className={`text-xl font-semibold mb-4 ${darkMode ? 'text-gray-200' : 'text-gray-800'}`}>
                      <i className="fas fa-chart-line mr-2" style={{ color: primaryColor }}></i>Moderator Performance
                    </h3>
